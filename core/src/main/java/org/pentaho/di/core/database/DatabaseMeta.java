...
public class DatabaseMeta extends SharedObjectBase implements Cloneable, XMLInterface, SharedObjectInterface,
  ...
  public boolean strictBigNumberInterpretation() {
    return databaseInterface instanceof OracleDatabaseMeta && ( (OracleDatabaseMeta) databaseInterface )
  ...
  public void setStrictBigNumberInterpretation( boolean strictNumberInterpretation  ) {
    if ( databaseInterface instanceof OracleDatabaseMeta ) {
      ( ( OracleDatabaseMeta )databaseInterface ).setStrictBigNumberInterpretation( strictNumberInterpretation );
    }
  }
